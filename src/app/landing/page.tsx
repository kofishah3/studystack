    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background text-text p-8">
      <div className="flex flex-col items-center gap-8 max-w-2xl w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md justify-center px-4">
          ...
          <Link
            href="/signup"
            className="flex-1 flex items-center justify-center whitespace-nowrap px-8 py-3.5 bg-white border-2 border-border text-text rounded-xl font-semibold hover:bg-gray-50 transition-all text-center min-h-[52px]"
          >
            Create Account
          </Link>
        </div>
        ...
        <div className="mt-12 flex flex-col items-center gap-4">
          <h3 className="text-sm font-semibold text-muted">Developed by</h3>
