...
export default function TopNavBar({}: TopNavBarProps) {
  ...
  return (
    <div id="navbar-container" className="sticky top-0 z-50 w-full">
      <div
        id="navbar-content-container"
        className="w-full bg-surface px-6 py-2.5 border-b border-border/50 
      justify-between items-center flex flex-row relative shadow-sm"
      >
        ...
        <div id="rightmost-container" className="flex flex-row gap-1">
          ...
          >
            ...
            >
              ...
              <p className="text-xs font-bold text-muted group-hover:text-primary-500/70 transition-colors duration-200">
                {education}
              </p>
            </div>
