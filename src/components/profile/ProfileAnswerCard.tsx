...
export default function ProfileAnswerCard(props: ProfileAnswerCardProps) {
  return (
    <div
      ...
      id={`profile-answer-card-wrapper-${props.id}`}
    >
      <div className="relative z-10" id={`profile-answer-card-${props.id}`}>
        <AnswerCard {...props} />
      </div>
      <div
        id={`profile-answer-footer-context-${props.id}`}
        className="
      ...
      >
        <div
          ...
          id={`answer-footer-left-${props.id}`}
        >
          ...
          <div className="flex flex-col min-w-0">
            ...
            <Link
              id={`answer-footer-question-link-${props.id}`}
        ...
        <div
          ...
          id={`answer-footer-right-${props.id}`}
        >
          <div
            className="flex items-center gap-1.5"
            id={`answer-footer-author-meta-${props.id}`}
          >
          ...
          <Link
            id={`answer-footer-view-question-btn-${props.id}`}
            href={`/questions/${props.questionId}`}
            className="
